/*
  ...
  @params:
    ...
    suggestionsId - optional id of an html element in which to display the tag suggestions, f.e. <div id="foo" /> </div>. If you want the suggestions to appear in a specific spot (AvT).
...
(function ($) {
    ...
    $.fn.tagSuggest = function (options) {
        ...
        return this.each(function () {
            var tagsElm = $(this);
            var suggestionsId = settings.suggestionsId;
            var elm = this;
            ...
            tagsElm.keypress(handleKeys).keyup(handleKeys).blur(function () {
            ...
            if (suggestionsId != null) {
                $('#' + suggestionsId).html(tagMatches);
            } else {
                tagsElm.after(tagMatches);
            }

            tagMatches = $(tagMatches).click(function (ev) {
                if ($(ev.target).is(settings.tagWrap.toLowerCase()) && $(ev.target).is('._tag_suggestion') ) {
